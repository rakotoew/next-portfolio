    ...
    return (
        <Layout>
            <div>
                ...
                <video controls src={"/video/pec.mp4"} style={{ width: "100%", height: "auto"}}/>
                <h3>Projet réalisé sur 1 an avec un équipe de 5 personne, en méthode Agile avec des sprints d&apos;1 à 2 semaines (avec utilisation de Scrumwise pour la gestion de projet)</h3>
